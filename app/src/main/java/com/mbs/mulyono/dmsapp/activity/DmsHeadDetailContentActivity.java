...
public class DmsHeadDetailContentActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Overview :"+recievedSkup);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setSubtitle(recievedData);

        if (recievedSkup.toString().trim().equals("HeaderOverview")) {
                                        ...
                                        if (recievedSkup.toString().trim().equals("ProductGroupOverview")) {
                                            ...
                                            if (recievedSkup.toString().trim().equals("CustChainOverview")) {
                                                ...
                                                if (recievedSkup.toString().trim().equals("MixedBonusOverview")) {
                                                    ...
                                                    Toast.makeText(DmsHeadDetailContentActivity.this, "meneng wae ..." + recievedData + " " + recievedSkup, Toast.LENGTH_LONG).show();
                                                }
                                            }
                                        }
                                    }
        ...
        getDmsOverview.enqueue(new Callback<DmsOverviewResponse>() {
            ...
            public void onResponse(Response<DmsOverviewResponse> response, Retrofit retrofit) {
                ...
                if (res.listItem.size() > 0) {
                    ...
                    DmsOverviewAdapter adapter = new DmsOverviewAdapter(DmsHeadDetailContentActivity.this, listItem);
                    lvDmsOverview.setAdapter(adapter);
                } else {
                    Toast.makeText(DmsHeadDetailContentActivity.this, "Dms Haeader not found", Toast.LENGTH_LONG).show();
                }
            }
        ...
        getDmsCustomerGrp.enqueue(new Callback<DmsCustomerGroupResponse>() {
            ...
            public void onResponse(Response<DmsCustomerGroupResponse> response, Retrofit retrofit) {
                ...
                if (res.listCustomerGroupItem.size() > 0) {
                    ...
                    DmsCustomerGroupAdapter adapter = new DmsCustomerGroupAdapter(DmsHeadDetailContentActivity.this, listCustomerGrpItem);
                    lvDmsOverview.setAdapter(adapter);
                } else {
                    Toast.makeText(DmsHeadDetailContentActivity.this, "Dms Customer Group not found", Toast.LENGTH_LONG).show();
                }
            }
        ...
        getDmsCustomerChain.enqueue(new Callback<DmsCustomerChainResponse>() {
            ...
            public void onResponse(Response<DmsCustomerChainResponse> response, Retrofit retrofit) {
                ...
                if (res.listCustomerChainItem.size() > 0) {
                    ...
                    DmsCustomerChainAdapter adapter = new DmsCustomerChainAdapter(DmsHeadDetailContentActivity.this, listCustomerChainItem);
                    lvDmsOverview.setAdapter(adapter);
                } else {
                    Toast.makeText(DmsHeadDetailContentActivity.this, "Dms Customer Chains not found", Toast.LENGTH_LONG).show();
                }
            }
        ...
        getDmsCustomer.enqueue(new Callback<DmsCustomerResponse>() {
            ...
            public void onResponse(Response<DmsCustomerResponse> response, Retrofit retrofit) {
                ...
                if (res.listCustomerItem.size() > 0) {
                    ...
                    DmsCustomerAdapter adapter = new DmsCustomerAdapter(DmsHeadDetailContentActivity.this, listCustomerItem);
                    lvDmsOverview.setAdapter(adapter);
                } else {
                    Toast.makeText(DmsHeadDetailContentActivity.this, "Dms Customer not found", Toast.LENGTH_LONG).show();
                }
            }
        ...
        getDmsProductGrp.enqueue(new Callback<DmsProductGroupResponse>() {
            ...
            public void onResponse(Response<DmsProductGroupResponse> response, Retrofit retrofit) {
                ...
                if (res.listProductGroupItem.size() > 0) {
                    ...
                    DmsProductGroupAdapter adapter = new DmsProductGroupAdapter(DmsHeadDetailContentActivity.this, listProductGroupItem);
                    lvDmsOverview.setAdapter(adapter);
                } else {
                    Toast.makeText(DmsHeadDetailContentActivity.this, "Dms Product Group not found", Toast.LENGTH_LONG).show();
                }
            }
        ...
        getDmsProduct.enqueue(new Callback<DmsProductResponse>() {
            ...
            public void onResponse(Response<DmsProductResponse> response, Retrofit retrofit) {
                ...
                if (res.listProductItem.size() > 0) {
                    ...
                    DmsProductAdapter adapter = new DmsProductAdapter(DmsHeadDetailContentActivity.this, listProdusctItem);
                    lvDmsOverview.setAdapter(adapter);
                } else {
                    Toast.makeText(DmsHeadDetailContentActivity.this, "Dms Product not found", Toast.LENGTH_LONG).show();
                }
            }
        ...
        getDmsOrder.enqueue(new Callback<DmsOrderResponse>() {
            ...
            public void onResponse(Response<DmsOrderResponse> response, Retrofit retrofit) {
                ...
                if (res.listOrderItem.size() > 0) {
                    ...
                    DmsOrderAdapter adapter = new DmsOrderAdapter(DmsHeadDetailContentActivity.this, listOrderItem);
                    lvDmsOverview.setAdapter(adapter);
                } else {
                    Toast.makeText(DmsHeadDetailContentActivity.this, "Dms Order Type not found", Toast.LENGTH_LONG).show();
                }
            }
        ...
        getDmsOrderValue.enqueue(new Callback<DmsOrderValueResponse>() {
            ...
            public void onResponse(Response<DmsOrderValueResponse> response, Retrofit retrofit) {
                ...
                if (res.listOrderValueItem.size() > 0) {
                    ...
                    DmsOrderValueAdapter adapter = new DmsOrderValueAdapter(DmsHeadDetailContentActivity.this, listOrderValueItem);
                    lvDmsOverview.setAdapter(adapter);
                } else {
                    Toast.makeText(DmsHeadDetailContentActivity.this, "Dms Order Value not found", Toast.LENGTH_LONG).show();
                }
            }
        ...
        getDmsMixedBonus.enqueue(new Callback<DmsMixedBonusResponse>() {
            ...
            public void onResponse(Response<DmsMixedBonusResponse> response, Retrofit retrofit) {
                ...
                if (res.listMixedBonusItem.size() > 0) {
                    ...
                    DmsMixedBonusAdapter adapter = new DmsMixedBonusAdapter(DmsHeadDetailContentActivity.this, listMixedBonusItem);
                    lvDmsOverview.setAdapter(adapter);
                } else {
                    Toast.makeText(DmsHeadDetailContentActivity.this, "Dms Mixed Bonus not found", Toast.LENGTH_LONG).show();
                }
            }
        ...
        getDmsSignature.enqueue(new Callback<DmsSignatureResponse>() {
            ...
            public void onResponse(Response<DmsSignatureResponse> response, Retrofit retrofit) {
                ...
                if (res.listSignatureItem.size() > 0) {
                    ...
                    DmsSignatureAdapter adapter = new DmsSignatureAdapter(DmsHeadDetailContentActivity.this, listSignatureItem);
                    lvDmsOverview.setAdapter(adapter);
                } else {
                    Toast.makeText(DmsHeadDetailContentActivity.this, "Dms Signature not found", Toast.LENGTH_LONG).show();
                }
            }
        ...
        getDmsDetHistory.enqueue(new Callback<DmsDetHistoryResponse>() {
            ...
            public void onResponse(Response<DmsDetHistoryResponse> response, Retrofit retrofit) {
                ...
                if (res.listDetHistoryItem.size() > 0) {
                    ...
                    DmsDetHistoryAdapter adapter = new DmsDetHistoryAdapter(DmsHeadDetailContentActivity.this, listDetHistoryItem);
                    lvDmsOverview.setAdapter(adapter);
                } else {
                    Toast.makeText(DmsHeadDetailContentActivity.this, "Dms Signature not found", Toast.LENGTH_LONG).show();
                }
    ...
    public static void toDmsHeadDetailContentActivity(Activity activity, String item, String skup) {
        Intent mIntent = new Intent(activity, DmsHeadDetailContentActivity.class);
