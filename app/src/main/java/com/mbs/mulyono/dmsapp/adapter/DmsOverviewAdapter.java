 ...
 */
public class DmsOverviewAdapter extends BaseAdapter{

    Activity activity;
    ArrayList<DmsOverviewItem> listItem;

    public DmsOverviewAdapter(Activity activity, ArrayList<DmsOverviewItem> listItem){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = inflater.inflate(R.layout.item_dms_overview_item, null);
